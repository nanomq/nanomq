    ...
    struct connect_param *param, bool isquic)
{
	...
	if (isquic) {
		...
		nng_dialer_set_int(dialer, NNG_OPT_QUIC_KEEPALIVE, 30);
		nng_dialer_set_uint64(dialer, NNG_OPT_QUIC_IDLE_TIMEOUT, 60);
		nng_dialer_set_uint64(dialer, NNG_OPT_QUIC_CONNECT_TIMEOUT, 30);
