...
int nnl_msg_pool_create(nnl_msg_pool **);
int nnl_msg_get(nnl_msg_pool *, nng_msg **);
int nnl_msg_put(nnl_msg_pool *, nng_msg **);
int nnl_msg_pool_resize(nnl_msg_pool *);
int nnl_msg_pool_empty(nnl_msg_pool *);
int nnl_msg_pool_full(nnl_msg_pool *);
int nnl_msg_put_force(nnl_msg_pool *, nng_msg **);
