...
| --------------------------------- | ------------- | ---------------------------------------------- |
| code                              | Integer       | 0                                              |
| data.basic.url                    | String        | 监听url。                                      |
| data.basic.num_taskq_thread       | Integer       | 任务线程数。                                   |
| data.basic.max_taskq_thread       | Integer       | 最大任务线程数。                               |
| data.basic.parallel               | Long          | 并行数。                                       |
| data.basic.property_size          | Integer       | 最大属性长度。                                 |
| data.basic.msq_len                | Integer       | 队列长度。                                     |
| data.basic.daemon                 | Boolean       | 守护进程。                                     |
| data.basic.qos_duration           | Integer       | QOS消息定时间隔时间。                          |
| data.basic.allow_anonymous        | Boolean       | 允许匿名登录。                                 |
...
`CONFIG_NAME`可设置为 `basic` ,`tls` ,`sqlite` ,`auth` ,`auth_http` ,`websocket` ,`http_server` ,`bridge` ,`aws_bridge`;
...
> 仅对配置文件中标注为 "Hot updatable"的参数生效
