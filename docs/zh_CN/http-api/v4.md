...
### GET /api/v4/configuration/basic

 返回当前`Basic`配置参数。

### GET /api/v4/configuration/tls

 返回当前`TLS`配置参数。

### GET /api/v4/configuration/sqlite

 返回当前`sqlite`配置参数。

### GET /api/v4/configuration/auth

 返回当前`auth`配置参数。

### GET /api/v4/configuration/auth_http

 返回当前`auth_http`配置参数。

### GET /api/v4/configuration/websocket

 返回当前`websocket`配置参数。

### GET /api/v4/configuration/http_server

 返回当前`http_server`配置参数。

### GET /api/v4/configuration/bridge

 返回当前`bridge`配置参数。

### GET /api/v4/configuration/aws_bridge

 返回当前`aws_bridge`配置参数。
