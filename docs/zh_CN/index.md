...
[**Stream Plugin**](./stream-plugin/README.md)：面向边缘流处理的插件机制，支持将业务逻辑编译为 `.so` 进行旁路处理。可进一步查看 [快速 Demo](./stream-plugin/quick-demo.md) 与 [AI 生成插件手册](./stream-plugin/ai-plugin-guide.md)。
