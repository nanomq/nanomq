...
[**Zephyr RTOS 移植**](./zephyr/port-to-zephyr.md)：将 broker 核心直接运行在 Zephyr RTOS 上，使不具备 POSIX 环境的 MCU 也能承载 MQTT Broker，省去现场的一台 Linux 边缘网关。已在 ESP32-S3 实机与 `qemu_x86` 上验证。
