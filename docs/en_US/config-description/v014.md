...
| Name                       | Type    | Description                                                  |
| -------------------------- | ------- | ------------------------------------------------------------ |
| sqlite.enable              | Boolean | Enable sqlite cache (*Deault: `false`*)                      |
...
bridges.mqtt.nodes[0].connector.proto_ver    | Boolean       | MQTT client version（4｜5）. 
...
bridges.mqtt.nodes[0].forwards               | Array[String] | Array of forward topics. 
...
bridges.sqlite | Object | Sqlite configuration for Bridge See  [Sqlite configuration](#Sqlite configuration) 
