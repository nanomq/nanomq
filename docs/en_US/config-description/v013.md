...
| bridge.mqtt.{NAME}.hybrid_bridging            | Boolean       | Hybrid bridging (_default `false` _), recommend to enable it when you want to take advantage of QUIC, but not sure if the public network support QUIC. |
