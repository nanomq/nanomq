...
```
### NanoMQ Reload
NanoMQ supports reload command and can dynamically update the configuration parameters of NanoMQ. Currently, it supports dynamic updates in four parts: `basic, sqlite, auth, log`. The detailed description of the parameters can be found in the [Configuration File](../config-description/v018.md) section.
