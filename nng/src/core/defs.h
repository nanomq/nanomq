...
#ifdef EMQ_PACKET_SIZE 
	#define NNI_EMQ_MAX_PACKET_SIZE sizeof(uint16_t)*EMQ_PACKET_SIZE	//switch to alloc
#else
	#define NNI_EMQ_MAX_PACKET_SIZE sizeof(uint16_t)*512	//switch to alloc
#endif

#ifdef EMQ_HEADER_SIZE 
	#define NNI_EMQ_MAX_HEADER_SIZE sizeof(uint8_t)*EMQ_HEADER_SIZE      //ONLY FIXED HEADER
#else
	#define NNI_EMQ_MAX_HEADER_SIZE sizeof(uint8_t)*5      		//ONLY FIXED HEADER
#endif

#ifdef EMQ_PROPERTY_SIZE 
	#define NNI_EMQ_MAX_PROPERTY_SIZE sizeof(uint8_t)*EMQ_PROPERTY_SIZE
#else
