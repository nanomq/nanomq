...
main()
{
	...
	char *cmd_sub_emqx[] = {"mosquitto_sub", "-h", "broker.emqx.io", "-p", "8883", "-t", "fwd1/test/ci", "-V", "mqttv5", "-q", "2", "--tls-use-os-certs", NULL};
	...
	char *cmd_pub_emqx = "mosquitto_pub -h broker.emqx.io -p 8883 -t recv/topic1/ci -m message-to-nmq -V mqttv5 -q 2 --tls-use-os-certs";
