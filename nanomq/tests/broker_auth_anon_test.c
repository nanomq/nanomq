...
nng_thread *nmq;
	...
	char *cmd_sub_nmq[] = {
	    "mosquitto_sub", "-h", "127.0.0.1", "-p", "1883", "-i", "correct_one", 
	    "-t", "test/#", "-V", "mqttv5", "-q", "2", 
	    "-u", "admin", "-P", "public",
	    NULL
	};
	...
	char *cmd_pub_nmq = "mosquitto_pub -h 127.0.0.1 -p 1883 -t test/anon -i 'pub_client' -m 'message-to-nmq' -u admin -P public";
